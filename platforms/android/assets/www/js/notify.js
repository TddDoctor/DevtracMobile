$(function() {
    ...
    $.fn.deleteBubble = function(notification) {
        return notifications.deleteNotification(notification);
    };
    
    $.fn.getNotifications = function() {
        return notifications.getNotifications('projects', 'all');
    };
